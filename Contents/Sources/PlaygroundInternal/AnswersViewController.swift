...
class AnswersViewController: UITableViewController, PlaygroundLiveViewMessageHandler, InputCellDelegate {
    ...
    override func viewDidLoad() {
        ...
        titleLabel.text = NSLocalizedString("No output to print", comment: "Title lablel when there is no output from the answers template")
        ...
        messageLabel.text = NSLocalizedString("Run your code to see your console program running.", comment: "Content lablel when there is no output from the answers template")
